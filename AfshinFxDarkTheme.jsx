...
const globalTheme = createTheme({
  palette: {
    ...
    mode: 'dark',
    primary: {
      main: 'rgba(55, 253, 254, 1)',
      contrastText: 'rgba(0, 0, 0, 1)',
    },
    secondary: {
      main: 'rgba(55, 253, 254, 0.87)',
    ...
    text: {
      primary: 'rgba(241, 249, 249, 1)',
      secondary: 'rgba(241, 249, 249, 0.7)',
    ...
    Primary: {
      ...
      Shades: {
        '8p': 'rgba(73, 162, 163, 0.08)',
        '16p': 'rgba(55, 253, 254, 0.46)',
        '12p': 'rgba(55, 253, 254, 0.37)',
        '30p': 'rgba(60, 217, 218, 0.32)',
        '50p': 'rgba(55, 253, 254, 0.96)',
      },
    },
    Secondary: {
      Main: 'rgba(55, 253, 254, 0.87)',
      ...
      Shades: {
        '8p': 'rgba(55, 253, 254, 0.08)',
        '16p': 'rgba(55, 253, 254, 0.16)',
        '12p': 'rgba(55, 253, 254, 0.12)',
        '30p': 'rgba(55, 253, 254, 0.3)',
        '50p': 'rgba(55, 253, 254, 0.5)',
      },
    },
    Action: {
    ...
    components: {
      ...
      MuiButton: {
        styleOverrides: {
          ...
          outlinedPrimary: {
            border: `1px solid rgba(50, 222, 223, 1)`,
            boxSizing: `border-box`,
            color: `rgba(50, 222, 223, 1)`,
            '&:hover': {
              backgroundColor: globalTheme.palette['Primary']['Shades']['8p'],
              border: `1px solid rgba(50, 222, 223, 1)`,
              boxSizing: `border-box`,
        ...
        styleOverrides: {
          root: {
            '&.MuiRadio-colorPrimary': {
              ...
              '&:hover': {
                backgroundColor: `rgba(73, 162, 163, 0.08)`,
              },
            },
            '&.MuiRadio-colorSecondary': {
              ...
              '&:hover': {
                backgroundColor: `rgba(55, 253, 254, 0.08)`,
              },
            },
            '&.MuiRadio-colorError': {
              color: `rgba(241, 249, 249, 0.7)`,
        ...
        styleOverrides: {
          ...
          track: {
            ...
            '.Mui-checked.MuiSwitch-colorPrimary.Mui-checked + &': {
              backgroundColor: 'rgba(55, 253, 254, 1)',
            },
            '.MuiSwitch-colorSecondary + &': {
              borderRadius: '10px',
              backgroundColor: 'rgba(255, 255, 255, 1)',
            ...
            '.Mui-checked.MuiSwitch-colorSecondary.Mui-checked + &': {
              backgroundColor: 'rgba(55, 253, 254, 0.87)',
            },
            '.MuiSwitch-colorError + &': {
              borderRadius: '10px',
              backgroundColor: 'rgba(255, 255, 255, 1)',
